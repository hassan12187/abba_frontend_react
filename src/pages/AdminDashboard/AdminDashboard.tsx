...
interface statCardType{
  title:string, value:string, icon:string, color:string, description:string
};
type T = string;
interface Dashboard{
  totalStudents:T,
...
const AdminDashboard = () => {
  ...
  const {data}:{data:Dashboard}=useCustomQuery("/api/admin/report/home-dashboard",token,"dashboard");
// console.log(dashboardData);
  ...
  const StatCard = ({ title, value, icon, color, description }:statCardType) => (
